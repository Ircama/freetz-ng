...
$(PKG)_CONFIGURE_OPTIONS += $(if $(and $(FREETZ_LIB_libcurl_WITH_CA_BUNDLE),$(or $(FREETZ_LIB_libcurl_WITH_OPENSSL),$(FREETZ_LIB_libcurl_WITH_MBEDTLS))),--with-ca-bundle=/etc/ssl/certs/ca-bundle.crt,--without-ca-bundle)
