...
$(PKG)_SOURCE_DOWNLOAD_NAME:=$(if $(FREETZ_PACKAGE_TREE_VERSION_ABANDON),tree_$($(PKG)_VERSION).orig.tar.gz,unix-$($(PKG)_VERSION).tar.gz)
...
$(PKG)_SITE_ABANDON:=https://ftp.debian.org/debian/pool/main/t/tree/
$(PKG)_SITE_CURRENT:=https://gitlab.com/OldManProgrammer/unix-tree/-/archive/$($(PKG)_VERSION)
$(PKG)_SITE:=$($(PKG)_SITE_$(if $(FREETZ_PACKAGE_TREE_VERSION_ABANDON),ABANDON,CURRENT))
