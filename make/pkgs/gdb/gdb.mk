$(call PKG_INIT_BIN, $(if $(FREETZ_GDB_VERSION_6_8),6.8,$(if $(FREETZ_GDB_VERSION_17_1),17.1,7.9.1)))
...
$(PKG)_HASH_17.1  :=14996f5f74c9f68f5a543fdc45bca7800207f91f92aeea6c2e791822c7c6d876
...
$(PKG)_REBUILD_SUBOPTS += FREETZ_GDB_VERSION_17_1
