...
### B
  ...
  * **[bandwhich 0.23.1](../../docs/make/bandwhich.md)<a id='bandwhich'></a>**<br>
  ...
  * **[bat 0.26.1](../../docs/make/bat.md)<a id='bat'></a>**<br>
  ...
  * **[bottom 0.12.3](../../docs/make/bottom.md)<a id='bottom'></a>**<br>
  ...
  * **[broot 1.56.4](../../docs/make/broot.md)<a id='broot'></a>**<br>
...
### D
  ...
  * **[dtach 0.9 (binary only)](../../docs/make/dtach.md)<a id='dtach'></a>**<br>
    dtach is a tiny program that emulates the detach feature of screen, allowing you to run a program in an environment that is protected from the controlling terminal and attach to it later.
     - [Usage](../../docs/make/dtach.md#usage)
...
### E
  ...
  * **[elFinder web file manager](../../docs/make/elfinder.md)<a id='elfinder'></a>**<br>
  ...
  * **[emailrelay: E-MailRelay 1.9 - DEPRECATED](../../docs/make/emailrelay.md)<a id='emailrelay'></a>**<br>
    E-MailRelay is a simple store-and-forward message transfer agent and proxy server. It runs on Unix-like operating systems (including Linux), and on Windows. When used as proxy server the E-MailRelay program (emailrelay) runs in the background and accepts e-mail from local e-mail client programs (KMail, Outlook etc.) or from the outside world, using the SMTP protocol. As soon as an e-mail message is received it is forwarded on to the next SMTP server for onward delivery. This becomes more useful when you add in your own message processing: as each message is received it can be passed one of your programs for editing, filtering, encrypting etc. When used as a store-and-forward transfer agent E-Mail- Relay runs in two modes: the storage daemon part, and the forwarding agent. The storage daemon waits for incoming mail and stores anything it receives in a spool directory. As a forwarding agent E-MailRelay pulls messages out of the	spool directory and passes them on to a remote server -- perhaps your ISP mail server. E-MailRelay can also run as a POP3 server so that e-mail client programs can read the spooled messages.
     - [Configuration Help](../../docs/make/emailrelay.md#configuration-help)
  ...
  * **[eSpeak 1.48.04 (binary only) - DEPRECATED](../../docs/make/espeak.md)<a id='espeak'></a>**<br>
    eSpeak is a compact open source software speech synthesizer for English and other languages.
     ...
     - [Invocation](../../docs/make/espeak.md#invocation)
     - [Note](../../docs/make/espeak.md#note)

  * **[eza 0.23.4](../../docs/make/eza.md)<a id='eza'></a>**<br>
...
### F
  ...
  * **[fortune 1.2 - DEPRECATED](../../docs/make/fortune.md)<a id='fortune'></a>**<br>
    Fortune is a small game that is meant to lighten up your life. It can be used to display a random entry from a cookie file. After having installed the package, just put some fortune- files into a directory and create a symbolic link to /var/media/fortunes like this: ln -s /var/media/ftp/ExternalDisk/fortunes/ /var/media/fortunes For your convenience I have packed some fortune-files up and uploaded them here: http://homepages.tu-darmstadt.de/~pkrueger/fortunes.7z If you'd rather get your own files, you could start looking here: http://www.freebsd.org/cgi/cvsweb.cg...tune/datfiles/
     - [Configuring the Package](../../docs/make/fortune.md#configuring-the-package)
     - [Showing Fortunes on Console Login](../../docs/make/fortune.md#showing-fortunes-on-console-login)
  ...
  * **[freetz-proxy 0.1 - HTTPS multi-service reverse proxy CGI](../../docs/make/freetz-proxy.md)<a id='freetz-proxy'></a>**<br>
    CGI binary that acts as an HTTPS-to-HTTP reverse proxy for multiple local services, allowing secure access via the FritzBox built-in HTTPS web interface. URL scheme: https://fritz.box/cgi-bin/freetz_proxy/ → HTML index of all configured services https://fritz.box/cgi-bin/freetz_proxy/freetz/ → Freetz-EVO (port from /mod/etc/conf/mod.cfg) https://fritz.box/cgi-bin/freetz_proxy/myapp/ → custom service on configured port Services are configured in /mod/etc/conf/freetz-proxy.cfg: freetz=81 myapp=9999 The "freetz" service is auto-added from MOD_HTTPD_PORT in /mod/etc/conf/mod.cfg when absent from the config file. Location: response headers are rewritten so that upstream redirects stay within the HTTPS proxy URL.
     - [Service entries](../../docs/make/freetz-proxy.md#service-entries)
     - [Security directives (`@key=value`)](../../docs/make/freetz-proxy.md#security-directives-keyvalue)
     - [Complete annotated example](../../docs/make/freetz-proxy.md#complete-annotated-example)
     - [`--set @key=value ...`](../../docs/make/freetz-proxy.md#--set-keyvalue-)
  ...
  * **[fzf 0.72.0 (binary only)](../../docs/make/fzf.md)<a id='fzf'></a>**<br>
...
### G
  ...
  * **[gh 2.83.2 - GitHub CLI](../../docs/make/gh.md)<a id='gh'></a>**<br>
  ...
  * **[glow 2.1.2 (binary only)](../../docs/make/glow.md)<a id='glow'></a>**<br>
  ...
  * **[gum 0.17.0 (binary only)](../../docs/make/gum.md)<a id='gum'></a>**<br>
  ...
  * **[gw6: Gateway6 client 5.1 - DEPRECATED](../../docs/make/gw6.md)<a id='gw6'></a>**<br>
    Client to build a tunnel to the ipv6 network (see http://go6.net). The binary will be installed as /usr/sbin/gw6c and CGI frontend will be provided for a simple configuration. A sample can be found in /usr/share/gw6/.
     - [Alternatives](../../docs/make/gw6.md#alternatives)
...
### H
  ...
  * **[hey 0.1.5 (binary only)](../../docs/make/hey.md)<a id='hey'></a>**<br>
  ...
  * **[hugo 0.161.1 (binary only)](../../docs/make/hugo.md)<a id='hugo'></a>**<br>
...
### I
  ...
  * **[iconv 1.13.1/1.18 (binary only) - see library for version](../../docs/make/iconv.md)<a id='iconv'></a>**<br>
  ...
  * **[Inetd 1.0](../../docs/make/inetd.md)<a id='inetd'></a>**<br>
    'Virtual' inetd package. Provides configuration framework for inetd. Requires a compatible inetd binary. (at the moment, only busybox inetd is supported)
     - [User-Defined](../../docs/make/inetd.md#user-defined)
     - [Configuration](../../docs/make/inetd.md#configuration)
     - [For Developers](../../docs/make/inetd.md#for-developers)
...
### J
  ...
  * **[jless 0.9.0](../../docs/make/jless.md)<a id='jless'></a>**<br>
...
### L
  ...
  * **[lazygit 0.61.1 (binary only)](../../docs/make/lazygit.md)<a id='lazygit'></a>**<br>
  ...
  * **[lf r41 (binary only)](../../docs/make/lf.md)<a id='lf'></a>**<br>
    This package cross-compiles the upstream Go sources and installs the lf executable on the target. Can be externalized to save flash memory.
     - [Basic key bindings (defaults)](../../docs/make/lf.md#basic-key-bindings-defaults)
     - [Example lfrc snippet](../../docs/make/lf.md#example-lfrc-snippet)
  ...
  * **[Lighttpd 1.4.85](../../docs/make/lighttpd.md)<a id='lighttpd'></a>**<br>
    Security, speed, compliance, and flexibility -- all of these describe lighttpd (pron. lighty) which is rapidly redefining efficiency of a webserver; as it is designed and optimized for high performance environments. With a small memory footprint compared to other web-servers, effective management of the cpu-load, and advanced feature set (FastCGI, SCGI, Auth, Output-Compression, URL-Rewriting and many more) lighttpd is the perfect solution for every server that is suffering load problems. In case you want to configure virtual hosts, you may want to consider the package onlinechanged-cgi which allows you to configure multiple DynDNS entries for your box.
     - [Setup](../../docs/make/lighttpd.md#setup)
  ...
  * **[lnav 0.14.0](../../docs/make/lnav.md)<a id='lnav'></a>**<br>
    This is the native C/C++ lnav package for the target system.

  * **[lnav-rs 0.1.0](../../docs/make/lnav-rs.md)<a id='lnav-rs'></a>**<br>
...
### M
  ...
  * **[MELCloud CLI + CGI dashboard](../../docs/make/melcloud.md)<a id='melcloud'></a>**<br>
  ...
  * **[microperl (binary only)](../../docs/make/microperl.md)<a id='microperl'></a>**<br>
  ...
  * **[minidlna 1.3.3](../../docs/make/minidlna.md)<a id='minidlna'></a>**<br>
    The MiniDLNA daemon is an UPnP-A/V and DLNA service which serves multimedia content to compatible clients on the network.
     - [Configuration](../../docs/make/minidlna.md#configuration)
...
### N
  ...
  * **[ncdu 1.19 (disk usage analyzer)](../../docs/make/ncdu.md)<a id='ncdu'></a>**<br>
  ...
  * **[NcFTP 3.3.0 (binaries only)](../../docs/make/ncftp.md)<a id='ncftp'></a>**<br>
    NcFTP is a free program that use the File Transfer Protocol. The purpose of ncftp is to provide a powerful and flexible interface to the Internet standard File Transfer Protocol. Although the program appears to be rather spartan, you'll find that ncftp has a wealth of valuable performance and usage features. The program was designed with an emphasis on usability, and it does as much as it can for you automatically so you can do what you expect to do with a file transfer program, which is transfer files between two interconnected systems.
     - [What is NcFTP?](../../docs/make/ncftp.md#what-is-ncftp)
     - [What Can NcFTP Be Used For?](../../docs/make/ncftp.md#what-can-ncftp-be-used-for)
     - [How Do I Install NcFTP?](../../docs/make/ncftp.md#how-do-i-install-ncftp)
     - [How Do I Start NcFTP?](../../docs/make/ncftp.md#how-do-i-start-ncftp)
     - [How Is the Command in the upload.sh Script Structured?](../../docs/make/ncftp.md#how-is-the-command-in-the-uploadsh-script-structured)
     - [What Does the Command for a download.sh Script Look Like?](../../docs/make/ncftp.md#what-does-the-command-for-a-downloadsh-script-look-like)
     - [How Can I Use a Different Port?](../../docs/make/ncftp.md#how-can-i-use-a-different-port)
  ...
  * **[nfs-utils 1.3.4 (binary only) - DEPRECATED](../../docs/make/nfs-utils.md)<a id='nfs-utils'></a>**<br>
    Linux NFS utility package Select nfsd-cgi if you want a configuration web interface. If this does not work, enable replace-kernel!
     - [Notes](../../docs/make/nfs-utils.md#notes)
     - [References](../../docs/make/nfs-utils.md#references)
  ...
  * **[Nginx 1.29.3](../../docs/make/nginx.md)<a id='nginx'></a>**<br>
  ...
  * **[nmon 16s (binary only)](../../docs/make/nmon.md)<a id='nmon'></a>**<br>
...
### O
  ...
  * **[OpenDD 0.7.9 - DEPRECATED](../../docs/make/opendd.md)<a id='opendd'></a>**<br>
    opendd is a DynDNS client, written in C, and especially designed for small gateway machines, like a Soekris box. Its main feature is that it does not require any Perl or Python interpreter. It supports HTTPS, can send a mail report, and can run as daemon. It is also very easy to deploy. WWW: http://www.bsdmon.com/wakka/OpenDD
     - [Update After 25 Days](../../docs/make/opendd.md#update-after-25-days)
  ...
  * **[OpenLDAP 2.6.8 (client tools)](../../docs/make/openldap.md)<a id='openldap'></a>**<br>
  ...
  * **[Openntpd 3.9p1 - DEPRECATED](../../docs/make/openntpd.md)<a id='openntpd'></a>**<br>
    OpenNTPD is a FREE, easy to use implementation of the Network Time Protocol. This package automatically removes AVM'S chronyd if necessary.
     - [Advantages:](../../docs/make/openntpd.md#advantages)
     - [Ubuntu client setup](../../docs/make/openntpd.md#ubuntu-client-setup)
     - [Disabling the Multid NTP Client](../../docs/make/openntpd.md#disabling-the-multid-ntp-client)
     - [Troubleshooting](../../docs/make/openntpd.md#troubleshooting)
  ...
  * **[OpenVPN 2.4.12/2.5.11/2.6.22/2.7.7](../../docs/make/openvpn.md)<a id='openvpn'></a>**<br>
    VPN Server
     ...
     - [Port Forwarding](../../docs/make/openvpn.md#port-forwarding)
     - [Static Key](../../docs/make/openvpn.md#static-key)
     - [Certificates](../../docs/make/openvpn.md#certificates)
     - [Routing vs. Bridging](../../docs/make/openvpn.md#routing-vs-bridging)
     - [Troubleshooting: A Few Tips If It Does Not Work Right Away](../../docs/make/openvpn.md#troubleshooting-a-few-tips-if-it-does-not-work-right-away)
     - [Encryption: Which "Cipher"?](../../docs/make/openvpn.md#encryption-which-cipher)
     - [DNS & Redirect all clients' traffic](../../docs/make/openvpn.md#dns--redirect-all-clients-traffic)
     - [Discussion](../../docs/make/openvpn.md#discussion)
     - [New, Simple GUI (GUI2)](../../docs/make/openvpn.md#new-simple-gui-gui2)
     - [Creating Additional Configurations](../../docs/make/openvpn.md#creating-additional-configurations)

  * **[oxker 0.13.2](../../docs/make/oxker.md)<a id='oxker'></a>**<br>
...
### P
  ...
  * **[pdns-authoritative: PowerDNS Authoritative Server 5.0.5](../../docs/make/pdns-authoritative.md)<a id='pdns-authoritative'></a>**<br>
    This freetz port packages the Authoritative Server only. Upstream recursor is not included here. dnsdist is available as a separate freetz package. jemalloc is selected to avoid allocator-related crashes observed on uClibc targets when using the default allocator. The default configuration stays close to the minimal upstream mode: no backend or optional server feature is enabled unless selected below.
     ...
     - [Upstream Features Not Wired In This Port](../../docs/make/pdns-authoritative.md#upstream-features-not-wired-in-this-port)
     - [Toolchain Requirement](../../docs/make/pdns-authoritative.md#toolchain-requirement)
     - [Notes](../../docs/make/pdns-authoritative.md#notes)

  * **[pdns-dnsdist: PowerDNS dnsdist 1.9.7](../../docs/make/pdns-dnsdist.md)<a id='pdns-dnsdist'></a>**<br>
  ...
  * **[pdns-recursor: PowerDNS Recursor 5.0.5](../../docs/make/pdns-recursor.md)<a id='pdns-recursor'></a>**<br>
  ...
  * **[PHP (binary only)](../../docs/make/php.md)<a id='php'></a>**<br>
    PHP: Hypertext Preprocessor PHP is a widely-used general-purpose scripting language that is especially suited for Web development and can be embedded into HTML. Note: This conflicts with PHP5 - only one can be selected. Note: PHP 8.5+ requires GCC 8.x or newer due to modern C language features, atomic operations, and compiler intrinsics requirements. For older toolchains (GCC 4.x-7.x), please use PHP 8.3.x or earlier instead.
     - [Core Extensions](../../docs/make/php.md#core-extensions)
     - [String & Data Processing](../../docs/make/php.md#string--data-processing)
     - [XML Processing](../../docs/make/php.md#xml-processing)
     - [Web & Network](../../docs/make/php.md#web--network)
     - [Database](../../docs/make/php.md#database)
     - [File & System](../../docs/make/php.md#file--system)
     - [Process Control](../../docs/make/php.md#process-control)
     - [Performance](../../docs/make/php.md#performance)
     - [Other](../../docs/make/php.md#other)
     - [Binary Selection](../../docs/make/php.md#binary-selection)
     - [Extension Options](../../docs/make/php.md#extension-options)
     - [Library Dependencies](../../docs/make/php.md#library-dependencies)
  ...
  * **[pptp 1.10.0](../../docs/make/pptp.md)<a id='pptp'></a>**<br>
    Linux and FreeBSD client for the proprietary Microsoft Point-to-Point tunneling protocol, PPTP, sponsored by HP.
     - [PPTP Configuration](../../docs/make/pptp.md#pptp-configuration)
  ...
  * **[pptpd 1.4.0 - DEPRECATED](../../docs/make/pptpd.md)<a id='pptpd'></a>**<br>
    Poptop is an open source implementation of a PPTP server. Running under x86 or embedded Motorola ColdFire architectures Poptop provides full interoperability with the Microsoft PPTP VPN client.
     - [Port Forwarding](../../docs/make/pptpd.md#port-forwarding)
     - [Configuration](../../docs/make/pptpd.md#configuration)
     ...
     - [Troubleshooting No Error Message](../../docs/make/pptpd.md#troubleshooting-no-error-message)
  ...
  * **[Privoxy 4.1.0](../../docs/make/privoxy.md)<a id='privoxy'></a>**<br>
    Privoxy is a web proxy with advanced filtering capabilities for protecting privacy, modifying web page data, managing cookies, controlling access, and removing ads, banners, pop-ups and other obnoxious Internet junk. It can also be used together with Tor Proxy to forward HTTP traffic to Tor as described in the Tor documentation. Open http://config.privoxy.org/show-status for details.
     - [Filters and Actions](../../docs/make/privoxy.md#filters-and-actions)
     - [Access Control](../../docs/make/privoxy.md#access-control)
     - [Privoxy and Tor](../../docs/make/privoxy.md#privoxy-and-tor)
     - [Transparent Proxy](../../docs/make/privoxy.md#transparent-proxy)
     - [Ad Filter](../../docs/make/privoxy.md#ad-filter)
     - [Installation](../../docs/make/privoxy.md#installation)
     - [Discussion](../../docs/make/privoxy.md#discussion)
  ...
  * **[procs 0.14.11](../../docs/make/procs.md)<a id='procs'></a>**<br>
    procs utility package built from source using Rust/Cargo.

  * **[prometheus 3.11.3 (binary only)](../../docs/make/prometheus.md)<a id='prometheus'></a>**<br>
  ...
  * **[python-pip: pip 20.3.4](../../docs/make/python-pip.md)<a id='python-pip'></a>**<br>
  ...
  * **[python3-aiodns: aiodns 4.0.0](../../docs/make/python3-aiodns.md)<a id='python3-aiodns'></a>**<br>
  ...
  * **[python3-aiohttp-fast-zlib: aiohttp-fast-zlib 0.3.0](../../docs/make/python3-aiohttp-fast-zlib.md)<a id='python3-aiohttp-fast-zlib'></a>**<br>
  ...
  * **[python3-cryptography: cryptography 48.0.0](../../docs/make/python3-cryptography.md)<a id='python3-cryptography'></a>**<br>
  ...
  * **[python3-grpcio: grpcio 1.78.0](../../docs/make/python3-grpcio.md)<a id='python3-grpcio'></a>**<br>
    gRPC Python bindings with native C/C++ core extensions.

  * **[python3-grpcio-reflection: grpcio-reflection 1.78.1](../../docs/make/python3-grpcio-reflection.md)<a id='python3-grpcio-reflection'></a>**<br>
    gRPC server reflection support for Python services.

  * **[python3-grpcio-status: grpcio-status 1.78.1](../../docs/make/python3-grpcio-status.md)<a id='python3-grpcio-status'></a>**<br>
    gRPC status helpers and rich error details support.

  * **[python3-h11: h11 0.16.0](../../docs/make/python3-h11.md)<a id='python3-h11'></a>**<br>
  ...
  * **[python3-httpx: httpx 0.28.1](../../docs/make/python3-httpx.md)<a id='python3-httpx'></a>**<br>
  ...
  * **[python3-ifaddr: ifaddr 0.2.0 (pure python, prerequisite)](../../docs/make/python3-ifaddr.md)<a id='python3-ifaddr'></a>**<br>
    Cross-platform network interface/address discovery library.

  * **[python3-lru-dict: lru-dict 1.4.1](../../docs/make/python3-lru-dict.md)<a id='python3-lru-dict'></a>**<br>
  ...
  * **[python3-mashumaro: mashumaro 3.17 (pure python, prerequisite)](../../docs/make/python3-mashumaro.md)<a id='python3-mashumaro'></a>**<br>
  ...
  * **[python3-psutil: psutil 7.2.2](../../docs/make/python3-psutil.md)<a id='python3-psutil'></a>**<br>
    Cross-platform process and system monitoring library.

  * **[python3-pycares: pycares 5.0.1](../../docs/make/python3-pycares.md)<a id='python3-pycares'></a>**<br>
  ...
  * **[python3-pymicro-vad: pymicro-vad 2.0.1](../../docs/make/python3-pymicro-vad.md)<a id='python3-pymicro-vad'></a>**<br>
    Lightweight voice activity detection extension for Python.

  * **[python3-pynacl: pynacl 1.6.2](../../docs/make/python3-pynacl.md)<a id='python3-pynacl'></a>**<br>
  ...
  * **[python3-typing-extensions: typing-extensions 4.15.0 (pure python, prerequisite)](../../docs/make/python3-typing-extensions.md)<a id='python3-typing-extensions'></a>**<br>
    Backported and experimental typing helpers for Python.

  * **[python3-ulid-transform: ulid-transform 2.2.9](../../docs/make/python3-ulid-transform.md)<a id='python3-ulid-transform'></a>**<br>
  ...
  * **[python3-uv: uv 0.11.16](../../docs/make/python3-uv.md)<a id='python3-uv'></a>**<br>
...
### R
  ...
  * **[rainfrog 0.3.18](../../docs/make/rainfrog.md)<a id='rainfrog'></a>**<br>
  ...
  * **[ripgrep 15.1.0](../../docs/make/ripgrep.md)<a id='ripgrep'></a>**<br>
...
### S
  ...
  * **[sha256sum 0.9.0](../../docs/make/sha256sum.md)<a id='sha256sum'></a>**<br>
  ...
  * **[SQLite 3.40.1/3.47.1/3.53.3 (binary only)](../../docs/make/sqlite.md)<a id='sqlite'></a>**<br>
...
### T
  ...
  * **[tac 0.9.0](../../docs/make/tac.md)<a id='tac'></a>**<br>
  ...
  * **[termscp 1.0.0](../../docs/make/termscp.md)<a id='termscp'></a>**<br>
...
### U
  ...
  * **[unixODBC 2.3.12 (tools)](../../docs/make/unixodbc.md)<a id='unixodbc'></a>**<br>
...
### X
  ...
  * **[xclock 1.1.1](../../docs/make/xclock.md)<a id='xclock'></a>**<br>
    X11 clock application. Use with DISPLAY=<remote-host>:0.

  * **[xeyes 1.3.1](../../docs/make/xeyes.md)<a id='xeyes'></a>**<br>
  ...
  * **[xterm 410](../../docs/make/xterm.md)<a id='xterm'></a>**<br>
...
### Y
  ...
  * **[yazi 26.5.6](../../docs/make/yazi.md)<a id='yazi'></a>**<br>
...
### Z
  ...
  * **[zoxide 0.9.9](../../docs/make/zoxide.md)<a id='zoxide'></a>**<br>
...
# Audio
  ...
  * **[alsaequal 0.7.1 - DEVELOPER](../../docs/make/alsaequal.md)<a id='alsaequal'></a>**<br>
...
# Debug helpers
  ...
  * **[ltrace 0.7.3-git/0.8.1 (binary only)](../../docs/make/ltrace.md)<a id='ltrace'></a>**<br>
    ltrace - library call tracer ltrace is a debugging tool, similar to strace, but it traces library calls instead of system calls.
     - [Using ltrace to inspect ctlmgr](../../docs/make/ltrace.md#using-ltrace-to-inspect-ctlmgr)
...
# Flasher tools
  ...
  * **[avrdude 8.1](../../docs/make/avrdude.md)<a id='avrdude'></a>**<br>
  ...
  * **[telink_tools 1.0](../../docs/make/telink_tools.md)<a id='telink-tools'></a>**<br>
