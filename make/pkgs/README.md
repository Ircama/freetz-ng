...
Content: [Packages](#packages) - [Debug helpers](#debug-helpers) - [External (3rd party) modules](#external-(3rd-party)-modules) - [Unstable](#unstable) - [Web interfaces](#web-interfaces)
# Packages
...
### B
  ...
  * **[binary-tools (readelf, objdump, objcopy, nm, strings, ar, ranlib, strip, addr2line, size)](../../docs/make/binary-tools.md)<a id='binary-tools'></a>**<br>
    Collection of essential tools for analyzing and manipulating ELF binaries: - readelf: Display information about ELF files - objdump: Display information from object files - objcopy: Copy and translate object files - nm: List symbols from object files - strings: Print the strings of printable characters in files - ar: Create, modify, and extract from archives - ranlib: Generate index to archive contents - strip: Remove symbols from object files - addr2line: Convert addresses to file names and line numbers - size: Display the sizes of sections in binary files Perfect for debugging cross-compiled binaries, analyzing shared libraries, troubleshooting dynamic linking issues, and complete binary analysis workflow. Total size: ~15MB Can be externalized to save flash memory.
     - [Available Tools](../../docs/make/binary-tools.md#available-tools)
     - [Inspecting Binaries](../../docs/make/binary-tools.md#inspecting-binaries)
     - [Debugging](../../docs/make/binary-tools.md#debugging)
     - [Binary Manipulation](../../docs/make/binary-tools.md#binary-manipulation)
     - [1. Debugging Crashes](../../docs/make/binary-tools.md#1-debugging-crashes)
     - [2. Analyzing Dependencies](../../docs/make/binary-tools.md#2-analyzing-dependencies)
     - [3. Reverse Engineering](../../docs/make/binary-tools.md#3-reverse-engineering)
     - [4. Reducing Binary Size](../../docs/make/binary-tools.md#4-reducing-binary-size)
     - ["command not found"](../../docs/make/binary-tools.md#command-not-found)
     - [Wrong Architecture Binaries](../../docs/make/binary-tools.md#wrong-architecture-binaries)
...
### C
  ...
  * **[CA-bundle 2025-09-09](../../docs/make/ca-bundle.md)<a id='ca-bundle'></a>**<br>
  ...
  * **[Curl 8.12.1/8.16.0 (binary only)](../../docs/make/curl.md)<a id='curl'></a>**<br>
...
### D
  ...
  * **[Dnsmasq 2.80/2.91](../../docs/make/dnsmasq.md)<a id='dnsmasq'></a>**<br>
    Combined DHCP, DNS and TFTP server.
     ...
     - [DHCP-Hosts Einträge --dhcp-host](../../docs/make/dnsmasq.md#dhcp-hosts-eintrge---dhcp-host)
...
### P
  ...
  * **[python3: Python 3.13.7](../../docs/make/python3.md)<a id='python3'></a>**<br>
    Python is a remarkably powerful dynamic programming language that is used in a wide variety of application domains. CAUTION: Python 3 adds roughly 10-20 MB of uncompressed data to your image. MUST be externalized to USB storage. Size: ~10-20 MB (depending on modules)
...
### T
  ...
  * **[Tor 0.4.8.18](../../docs/make/tor.md)<a id='tor'></a>**<br>
...
### U
  ...
  * **[UnRAR 6.1.7/7.1.10 (binary only)](../../docs/make/unrar.md)<a id='unrar'></a>**<br>
...
# Debug helpers
  ...
  * **[gcc-toolchain: GCC (Native Compiler for On-Device Compilation)](../../docs/make/gcc-toolchain.md)<a id='gcc-toolchain'></a>**<br>
    Install the GCC compiler on Fritz!Box for native compilation. This package takes the already-compiled GCC from the build toolchain and packages it for installation on the target device. WARNING: Size ~200-250 MB. MUST be externalized to USB storage. Perfect for: - Building Python C extension modules (pip install --no-binary) - On-device C/C++ development - Compiling small programs directly on router After installation, externalize to USB: Files in: /tmp/flash/gcc-toolchain/ Move to:  /var/media/ftp/uStor01/freetz-external/
     - [Primary Use Case: Python C Extensions](../../docs/make/gcc-toolchain.md#primary-use-case-python-c-extensions)
     - [Secondary Use Cases](../../docs/make/gcc-toolchain.md#secondary-use-cases)
     - [⚠️ Build System Requirements](../../docs/make/gcc-toolchain.md#-build-system-requirements)
     - [⚠️ CRITICAL: External Storage Required (Target Device)](../../docs/make/gcc-toolchain.md#-critical-external-storage-required-target-device)
     - [1. Enable in Menuconfig](../../docs/make/gcc-toolchain.md#1-enable-in-menuconfig)
     - [2. Build the Image](../../docs/make/gcc-toolchain.md#2-build-the-image)
     - [3. Flash the Modified Firmware](../../docs/make/gcc-toolchain.md#3-flash-the-modified-firmware)
     - [4. Setup External Storage](../../docs/make/gcc-toolchain.md#4-setup-external-storage)
     - [5. Verify Installation](../../docs/make/gcc-toolchain.md#5-verify-installation)
     - [Before Installing Python Packages](../../docs/make/gcc-toolchain.md#before-installing-python-packages)
     - [Install Python Packages with C Extensions](../../docs/make/gcc-toolchain.md#install-python-packages-with-c-extensions)
     - [Troubleshooting Python Extensions](../../docs/make/gcc-toolchain.md#troubleshooting-python-extensions)
     - [Full Installation (~250 MB)](../../docs/make/gcc-toolchain.md#full-installation-250-mb)
     - [Minimal Installation (~200 MB)](../../docs/make/gcc-toolchain.md#minimal-installation-200-mb)
     - [How It Works](../../docs/make/gcc-toolchain.md#how-it-works)
     - [Relationship to Freetz-NG Toolchain](../../docs/make/gcc-toolchain.md#relationship-to-freetz-ng-toolchain)
     - [Version Compatibility](../../docs/make/gcc-toolchain.md#version-compatibility)
     - [Checking Size](../../docs/make/gcc-toolchain.md#checking-size)
     - [Freeing Up Space](../../docs/make/gcc-toolchain.md#freeing-up-space)
